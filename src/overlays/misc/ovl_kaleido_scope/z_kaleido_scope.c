...
u8 gSlotAgeReqs[ITEMSCREEN_WIDTH * ITEMSCREEN_HEIGHT] = {
    ...
    AGE_REQ_NONE,  // SLOT_BOTTLE_5
    AGE_REQ_NONE,  // SLOT_BOTTLE_6
...
u8 gItemAgeReqs[NUM_ITEMS] = {
    ...
    AGE_REQ_NONE,  // ITEM_SONG_MINUET
    AGE_REQ_NONE,  // ITEM_SONG_BOLERO
    AGE_REQ_NONE,  // ITEM_SONG_SERENADE
    AGE_REQ_NONE,  // ITEM_SONG_REQUIEM
    AGE_REQ_NONE,  // ITEM_SONG_NOCTURNE
    AGE_REQ_NONE,  // ITEM_SONG_PRELUDE
    AGE_REQ_NONE,  // ITEM_SONG_LULLABY
    AGE_REQ_NONE,  // ITEM_SONG_EPONA
    AGE_REQ_NONE,  // ITEM_SONG_SARIA
    AGE_REQ_NONE,  // ITEM_SONG_SUN
    AGE_REQ_NONE,  // ITEM_SONG_TIME
    AGE_REQ_NONE,  // ITEM_SONG_STORMS
    AGE_REQ_NONE,  // ITEM_MEDALLION_FOREST
    AGE_REQ_NONE,  // ITEM_MEDALLION_FIRE
    AGE_REQ_NONE,  // ITEM_MEDALLION_WATER
    AGE_REQ_NONE,  // ITEM_MEDALLION_SPIRIT
    AGE_REQ_NONE,  // ITEM_MEDALLION_SHADOW
    AGE_REQ_NONE,  // ITEM_MEDALLION_LIGHT
    AGE_REQ_NONE,  // ITEM_KOKIRI_EMERALD
    AGE_REQ_NONE,  // ITEM_GORON_RUBY
    AGE_REQ_NONE,  // ITEM_ZORA_SAPPHIRE
    AGE_REQ_NONE,  // ITEM_STONE_OF_AGONY
    AGE_REQ_NONE,  // ITEM_GERUDOS_CARD
    AGE_REQ_NONE,  // ITEM_SKULL_TOKEN
    AGE_REQ_NONE,  // ITEM_HEART_CONTAINER
    AGE_REQ_NONE,  // ITEM_HEART_PIECE
    AGE_REQ_NONE,  // ITEM_DUNGEON_BOSS_KEY
    AGE_REQ_NONE,  // ITEM_DUNGEON_COMPASS
    AGE_REQ_NONE,  // ITEM_DUNGEON_MAP
    AGE_REQ_NONE,  // ITEM_SMALL_KEY
    AGE_REQ_NONE,  // ITEM_MAGIC_JAR_SMALL
    AGE_REQ_NONE,  // ITEM_MAGIC_JAR_BIG
    AGE_REQ_NONE,  // ITEM_HEART_PIECE_2
    AGE_REQ_NONE,  // ITEM_INVALID_1
    AGE_REQ_NONE,  // ITEM_INVALID_2
    AGE_REQ_NONE,  // ITEM_INVALID_3
    AGE_REQ_NONE,  // ITEM_INVALID_4
    AGE_REQ_NONE,  // ITEM_INVALID_5
    AGE_REQ_NONE,  // ITEM_INVALID_6
    AGE_REQ_NONE,  // ITEM_INVALID_7
    AGE_REQ_NONE,  // ITEM_MILK
    AGE_REQ_NONE,  // ITEM_RECOVERY_HEART
    AGE_REQ_NONE,  // ITEM_RUPEE_GREEN
    AGE_REQ_NONE,  // ITEM_RUPEE_BLUE
    AGE_REQ_NONE,  // ITEM_RUPEE_RED
    AGE_REQ_NONE,  // ITEM_RUPEE_PURPLE
    AGE_REQ_NONE,  // ITEM_RUPEE_GOLD
    AGE_REQ_NONE,  // ITEM_INVALID_8
    AGE_REQ_NONE,  // ITEM_DEKU_STICKS_5
    AGE_REQ_NONE,  // ITEM_DEKU_STICKS_10
    AGE_REQ_NONE,  // ITEM_DEKU_NUTS_5
    AGE_REQ_NONE,  // ITEM_DEKU_NUTS_10
    AGE_REQ_NONE,  // ITEM_BOMBS_5
    AGE_REQ_NONE,  // ITEM_BOMBS_10
    AGE_REQ_NONE,  // ITEM_BOMBS_20
    AGE_REQ_NONE,  // ITEM_BOMBS_30
    AGE_REQ_NONE,  // ITEM_ARROWS_5
    AGE_REQ_NONE,  // ITEM_ARROWS_10
    AGE_REQ_NONE,  // ITEM_ARROWS_30
    AGE_REQ_NONE,  // ITEM_DEKU_SEEDS_30
    AGE_REQ_NONE,  // ITEM_BOMBCHUS_5
    AGE_REQ_NONE,  // ITEM_BOMBCHUS_20
    AGE_REQ_NONE,  // ITEM_DEKU_STICK_UPGRADE_20
    AGE_REQ_NONE,  // ITEM_DEKU_STICK_UPGRADE_30
    AGE_REQ_NONE,  // ITEM_DEKU_NUT_UPGRADE_30
    AGE_REQ_NONE,  // ITEM_DEKU_NUT_UPGRADE_40
    AGE_REQ_NONE,  // ITEM_POWDER_KEG
};
